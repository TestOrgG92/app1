    ...
    const element = String.raw`
				<li class="ui segment grid equal width">
					<div class="ui checkbox column">
						<input id="${task.id}" class="checkboxitem" type="checkbox" ${task.completed ? "checked" : ""}>
...
$('.checkboxitem').click(function() {
  console.log("In Chcked");
  if ($(this).is(':checked')) {
    console.log("Yes Chcked");
    $('#clear-completed-tasks').removeAttr('disabled');
    completeTask($(this).attr("id"));
  } else {
    console.log("No Chcked");
    $('#clear-completed-tasks').attr('disabled', 'disabled');
  }
});
});
/**
